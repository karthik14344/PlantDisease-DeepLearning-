"""Quick evaluation of the original end-to-end CBAM-YOLO-MT on val + test."""
import sys
...
from src.config import (
    MODELS_DIR, NUM_CLASSES, NUM_SEVERITY, DEVICE,
    USE_CBAM, USE_BIFPN, USE_SEVERITY_GATE,
)

CKPT_DIR = MODELS_DIR / "multitask" / "yolo11n_multitask_lambda0.5_20260416_0925"
